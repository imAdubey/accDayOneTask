...
const poolData = {
    UserPoolId: "ap-south-1_ATnWEgkYx",
    ClientId: "1mt6bpmcs5mgtmjd2vvpcg44h6"
};
const poolRegion = "ap-south-1";
...
const validation = (req, res, next)=>{
    ...
    // console.log("##currUser##: ", cognitoCurrentUser);
    ...
    // console.log("decodedJwt: ", decodedJwt.payload.client_id);
